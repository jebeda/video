...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 18 17:07:41 2020
...
matching_threshold=100 #1.1 upper the better
...
#capture = cv2.VideoCapture('00004.MTS')
  ...
  # Get handles to input and output tensors
    ...
    while capture.isOpened():
        ...
        if len(personDetected) ==0:
            print('Cont activated, curframe:',frameIdx)
        ...
        #if cv2.waitKey()=='':
        #    print('y')
        cv2.imwrite(savepath+'output_'+str(frameIdx)+'.jpg', frame)
        frameIdx=frameIdx+1
